...
<body>
  <div class="title-box">20 Hari Lagi Kak Thania Theresia Podung Ulang Tahun! 🎉🎂🥳</div>


  <div class="music-box">
    <h2>OUR DAWN IS HOTTER THAN DAYY</h2>
    <p>SEVENTEEN</p>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 9.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('Seventeen-Our Dawn is Hotter Than Day.mp3');
    ...
    const fullMessage = `"Setiap hari adalah halaman kosong yang menanti untuk kita isi dengan cerita baru 🌼. Tidak peduli seberapa berat kemarin, hari ini adalah awal yang penuh harapan dan kemungkinan tak terbatas 🌻. Hari ini adalah kesempatan untuk memulai lagi, untuk menjadi lebih baik, dan untuk menciptakan kisah yang lebih indah dari yang pernah dibayangkan 🤍."`;
